<template>
	<view>
		...
		<view class="box">
			...
			<view class="li_item">
				<view class="icon-icon-test2 iconfont"></view>
				<input type="text" v-model="password" placeholder="请输入密码" maxlength="16" placeholder-style="color:#B3B3B3;font-size:28upx;line-height:34upx"/>
				<view class="get" @click="forget">忘记密码</view>
			</view>
		</view>
		...
		<view class="funtion">
			<view class="account" @click="messagelogin">短信验证码登录</view>
			<view class="new" @click="newreg">新用户注册</view>
		</view>
		<view class="threelogin">
			<view class="hline"></view>
			<view class="threetxt"  @click="logins('weixin')">第三方登录方式</view>
			<view class="hline"></view>
		</view>
		<view class="wechat">
									...
									if (res.code === 1) {
										...
										app.$vm.getData({
											...
											if(res.code==1){
												...
												uni.navigateTo({
														url: "./firstbind?provide_id=" + provide_id + "&provide=" + type
												})
											}
										})
